package com.example.application.widget.view;
...
//                y + mItemHeight - mH - mPadding, mSchemeBasicPaint);
        canvas.drawCircle(x + mItemWidth / 2, y + mItemHeight - mH / 2, mW / 2, mSchemeBasicPaint);
    }
    ...
    protected void onDrawText(Canvas canvas, Calendar calendar, int x, int y, boolean hasScheme, boolean isSelected) {
        ...
        if (hasScheme) {
            canvas.drawText("3", cx, mTextBaseLine + top,
